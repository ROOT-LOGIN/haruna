...
{    
    ...
    public class MasmClassifierProvider : IClassifierProvider
    {
        [Import]
    ...
    internal class MasmClassifier : GeneralAsmClassifier
    {        
        public MasmClassifier(ITextBuffer textBuffer, IClassificationTypeRegistryService registry)
        ...
        {
            simpleAsmLineParser = new SimpleAsmLineParser(AsmClassifierFamilyType.Masm);
        }
